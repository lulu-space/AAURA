-- Assign application role from campus email domain at signup provisioning.
-- @staff.aaup.edu  -> staff
-- @aaup.edu        -> student_affairs (faculty / affairs accounts)
-- @student.aaup.edu -> student (default)
...
is 'Backend provisioning helper: creates public.users with role inferred from AAUP email domain.';
