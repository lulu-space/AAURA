...
router.get(
  '/reports/:type',
  deanOnly,
  validateRequest(deanReportParamsSchema),
  asyncHandler((req, res) => deanController.report(req, res))
);
router.post(
  '/announcements',
  deanOnly,
  validateRequest(deanAnnouncementSchema),
  asyncHandler((req, res) => deanController.announce(req, res))
);
router.get(
  '/announcements',
  deanOnly,
  asyncHandler((req, res) => deanController.announcements(req, res))
);
