...
router.post('/shams/chat', validateRequest(shamsChatSchema), asyncHandler((req, res) => profilingWorkflowController.shamsChat(req, res)));
...
router.post('/drafts/regenerate', asyncHandler((req, res) => profilingWorkflowController.regenerateDraft(req, res)));
