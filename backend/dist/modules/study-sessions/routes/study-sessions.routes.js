...
import { createStudySessionSchema, updateStudySessionSchema } from '../dto/study-sessions.dto.js';
import { z } from 'zod';
...
const router = Router();
router.post('/:id/notify-members', validateRequest(notifyMembersSchema), asyncHandler((req, res) => studySessionsWorkflowController.notifyMembers(req, res)));
